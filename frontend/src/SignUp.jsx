    ...
    <div className="page-wrap">
      <div className="form-center">
        ...
        <div className="card">
          ...
          <InputWithIcon icon={lockIcon} type="password" placeholder="Confirm Password" value={conf} onChange={e=>setConf(e.target.value)}/>
          ...
          <div className="foot-note">Already have an account? <Link to="/signin" className="link">Sign In</Link></div>
        </div>
      </div>
    </div>
  );
